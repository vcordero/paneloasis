...
print $_GET['Smessage'];
  ...
  print  "</div>";
          ...
          ?>
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Supplier Bills</h3>
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php
                                                                                                $SqlStat = "SELECT distinct invoice_id,client_to,representative,type_of_payment,job,Date,deposit,balance,total  FROM  invoice_supplier where type='bill' ORDER BY id DESC";
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="blue" href="dashboard.php?p=convert-to-supplier-invoice&invoice_id=<?php echo $row['invoice_id']; ?>">
																	<i class="icon-file bigger-130"></i>
																</a>
																<a class="green" href="dashboard.php?p=edit_supplier_bill&invoice_id=<?php echo $row['invoice_id']; ?>">
	<?php if($data['type']=='1'){?>																<i class="icon-pencil bigger-130"></i>
																</a>
...
<a class="red" href="deletesupplierbill.php?invoice_id=<?php echo $row['invoice_id']; ?>" onclick="deleteBill();">
