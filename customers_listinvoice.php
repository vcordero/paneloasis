...
$SqlStat = "SELECT invoice_id,invoice_no,client_to,representative,type_of_payment,job,Date,deposit,balance,total FROM invoice where type='invoice' ORDER BY invoice_no DESC";
$result = mysql_query($SqlStat);

?>
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">List of Invoices</h3>
...
<a class="red" href="deletecustomerinvoice.php?invoice_id=<?php echo $row['invoice_id']; ?>" onclick="deleteBill();">
