...
$SqlStat = "SELECT  email,name,phone,order_number,order_date FROM order_web WHERE dispenser = 1 group by order_number ORDER BY order_date DESC";
...
<div class="row">
    <div class="col-xs-12">
        ...
        <?php endif; endif; ?>
        <h3 class="header smaller lighter blue">Order List Appoved</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="blue" href="dashboard.php?p=detail_order_web_return&id=<?php echo $row[3]; ?>">
