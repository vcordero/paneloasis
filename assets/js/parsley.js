...
!function ($) {
  ...
  */
  var Validator = function ( options ) {
    ...
    * @type {Object}
    */
    //var form_ = document.getElementById('frm_SMTPCONFIG');
    this.messages = {
      ...
      , type: function () {
        return {
          validate: function ( val, type ) {
            ...
            var form_ = document.getElementById('frm_SMTPCONFIG');
            //alert(form_);
            if(typeof  form_ !== 'undefined' && form_ != null && form_.name != '' && typeof form_.name != 'undefined' && form_.name == 'frm_SMTPCONFIG' && type=='email'){}
            else{
            switch ( type ) {
              case 'number':
...
function checkEmailAddresses(){
    var forms_ = document.getElementById('frm_SMTPCONFIG');
    var true_false = false;
    var true_false1 = false;
    var error_msg = document.getElementById('email_validations_ul');
    var error_msg1 = document.getElementById('email_validations_u');
                    
    if(typeof forms_ != 'undefined'){
        var emailAddresses1 = forms_.from_email;
        var emailAddresses = forms_.to_admin;
        var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        if(typeof emailAddresses != 'undefined'){
            //alert(emailAddresses.value);
            var emails = emailAddresses.value.split(",");
            
            for(email in emails){
                //alert(emails[email]);
                if(emails[email] == '' || typeof emails[email] == 'undefined'){
                    //alert("This value should be a valid email.");
                    error_msg.style.display = "list-item";
                    emailAddresses.focus();
                    true_false = false;
                    break;
                }
                else if(re.test(emails[email])===false){
                    //alert("This value should be a valid email.");
                    error_msg.style.display = "list-item";
                    emailAddresses.focus();
                    true_false = false;
        ...
        if(typeof emailAddresses1 != 'undefined'){
                var emails1 = emailAddresses1.value;
                if(typeof emails1 === 'undefined'){
                    error_msg1.style.display = "list-item";
                    emailAddresses1.focus();
                    true_false1 = false;
                }
                else if(re.test(emails1)===false){
                    //alert("This value should be a valid email.");
                    error_msg1.style.display = "list-item";
                    emailAddresses1.focus();
                    true_false1 = false;
    ...
    if(true_false===true&&true_false1===true){
        return true;
    }
    else{
        return false;
