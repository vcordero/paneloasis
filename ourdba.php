...
*/
 ...
 $ACCESS_PWD='ordenesfragan'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"fragclientsynpro",#required
 'pwd'=>"aleluya1", #required
 'db'=>"c4fragclientsynpro",  #optional, default DB
 'host'=>"db.suranetworksolution.com",#optional
 'port'=>"",#optional
