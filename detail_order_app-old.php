...
<div class="col-xs-12">
	<p style="text-align:right"><a href="reporteexcelapp.php"><img src="assets/img/excel.png">Get Report</a></p>
</div>
<div class="row">
<div class="col-xs-12">
	...
	<div class="table-responsive">
		...
		<div style="text-align:center;margin-top:20px;">
			<form method="POST" action="functions/appove_order.php">
				...
				<input type="submit" value="Dispenser" name="orderapp" class="btn btn-primary">
