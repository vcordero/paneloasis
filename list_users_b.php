...
include 'config.php';
$user=$_SESSION['user'];
$query=$mysqli->query("select * from users where role =2");
$data=mysqli_fetch_assoc($query);


    
   
$SqlStat = "SELECT * FROM users where role = 2 ORDER BY id DESC";
...
<div class="row">
    <div class="col-xs-12">
        ...
        <?php endif; endif; ?>
        <h3 class="header smaller lighter blue">Customers type B</h3>
