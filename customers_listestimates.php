...
$SqlStat = "SELECT distinct invoice_id,invoice_no,client_to,representative,type_of_payment,job,Date,deposit,balance,total FROM invoice where type='estimate' ORDER BY invoice_id DESC";
												 ...
												 ?>
													<tr>
														...
														<td>
                                                                ...
                                                                <a class="blue" href="dashboard.php?p=convert-to-bill&invoice_id=<?php echo $row['invoice_id']; ?>">
																	<i class="icon-file bigger-130"></i>
																</a>  

																<a class="blue" href="dashboard.php?p=duplicate_estimate&invoice_id=<?php echo $row['invoice_id']; ?>">
																	<i class="icon-copy bigger-130"></i>
																</a>

																
																<a class="green" href="dashboard.php?p=edit_customers_estimate&invoice_id=<?php echo $row['invoice_id']; ?>">
...
<a class="red" href="deletecustomerestimate.php?invoice_id=<?php echo $row['invoice_id']; ?>" onclick="deleteBill();">
